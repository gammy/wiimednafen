...
#include "help.h"
#else
#include "Emulators.h" // FIXME WIIFIX ? Might be legacy crud
#ifdef WII_NETTRACE
#include <network.h>
#include "net_print.h"
#endif
...
{
#ifndef WII
// FIXME WIIFIX Should all of this be left out, really? Code's too different from wiiport to tell..
...
#else
    // XXX WIIFIX, is this out of date?
